...
import { Send, ArrowLeft, CheckCircle, Menu, X, FileText, AlertCircle, MessageSquare } from 'lucide-react';
...
import { PqrFormData, FormErrors, pqrTypesConfig } from '@Types/Pqr';
import { useDispatch, useSelector } from 'react-redux';
import type { RootState, AppDispatch } from '@/app/Redux/store';
import { addPqr, updatePqr, deletePqr } from '@slice/pqrSlice';
...
const CreatePqrForm = () => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            // Formatear los datos según el pqrInput esperado
            ...
            <div className="flex-1 flex flex-col min-w-0">
                ...
                <div className="flex-1 overflow-y-auto">
                    <div className="max-w-none lg:max-w-4xl xl:max-w-5xl 2xl:max-w-6xl mx-auto px-4 py-4 sm:px-6 sm:py-6 lg:px-8 lg:py-8">
                        ...
                        {/* Navigation Buttons */}
                        <div className="flex flex-col sm:flex-row justify-between gap-4 mt-8 pt-6 border-t border-light-border dark:border-dark-border max-w-none lg:max-w-2xl xl:max-w-3xl mx-auto">
                            <button
                                type="button"
                                onClick={prevStep}
