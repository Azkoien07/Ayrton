...
import UserPagesCarousel from '@/app/Components/UserPagesCarousel';
import UserCalendar from '@/app/Components/UserCalendar';
...
interface UserBasicPageProps {
  searchParams?: Promise<any>;
}

const Page = async ({ searchParams }: UserBasicPageProps) => {
  const resolvedSearchParams = searchParams ? await searchParams : {};
  const role = resolvedSearchParams.role || 'admin';
  return <UserBasicContent role={role} />;
};
