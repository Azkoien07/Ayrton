...
const usePqrHandlers = () => {
    ...
    const handleAddPqr = async (input: AddPqrMutationVariables["input"]) => {
        try {
            const result = await dispatch(addPqr(input));
    ...
    const handleUpdatePqr = async (variables: UpdatePqrMutationVariables) => {
        try {
            const result = await dispatch(updatePqr(variables));
